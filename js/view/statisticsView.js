...
{	
	...
	var vis = d3.select("#topviewed").append("svg:svg")
	  .attr("width", w)
	  .attr("height", h);
		...
		for (i = 0; i< totalVisitedPerSite.length; i++)
	 	{
  	   	...
  	   	totalVisitedContainer.html("Total amount of websites visited the last 90 days: "+totalVisited);
	  	topSitesBox.html("Top 5 most visited sites:")

	  	for(i=0; i<topData.length; i++)
	  	{
	  		var topSites  = $("<div>");
	  		topSites.html(topData[i][0]+": "+topData[i][1]);
	  		topSitesBox.append(topSites);
	  	}	
	  		topSites.html("Other: "+otherCount);
	  		topSitesBox.append(topSites);


	  	//////////////////////////////////////
	  	//	Beginning of chart builder		//
	  	//////////////////////////////////////
